...
Axiom 采用“活页”的视觉人格：它像一件持续被使用、重排和留下痕迹的认知器物，以冷静纸面、编辑秩序和少量矿物色组织注意力。此刻只留下一个可以开始的焦点，资料库是一册输入即查的连续索引，Atlas 则在需要远观关系时切换为深色空间。完整方向见 [`docs/FRONTEND_ART_DIRECTION.md`](docs/FRONTEND_ART_DIRECTION.md)。
