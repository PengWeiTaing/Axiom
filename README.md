...
Axiom 采用“墨与光”的视觉人格：用中国山水式留白承载未被打扰的个人世界，用现代主义秩序组织信息，用克制的状态光标记正在发生的意义。此刻是一段行动长卷，资料库是一册生长中的索引，Atlas 是可远观也可近读的认知场。完整方向见 [`docs/FRONTEND_ART_DIRECTION.md`](docs/FRONTEND_ART_DIRECTION.md)。
