...
研究报告里的 MVP 判断是：系统首先应该跑通“采集 - 记忆 - 计划 - 回顾 - 微干预”闭环。这个基础闭环仍然有效，但它不是终点；下一阶段的中枢方向是“观察 - 选题 - 规律 - 假说 - 验证 - 发现 - 行动 - 校准”，完整研究见 [`docs/AXIOM_DISCOVERY_CORTEX_RESEARCH_V2.md`](docs/AXIOM_DISCOVERY_CORTEX_RESEARCH_V2.md)。
...
- 让桌面端、PWA 与未来移动端共享同一套低摩擦产品核心与数据契约。
