...
TOPIC_RULES = [
    {
        "key": "product_model",
        "label": "产品模型",
        "summary": "此刻、资料库、一级入口和对象降级相关的产品结构。",
        "keywords": ("产品模型", "十三个", "平级工作台", "一级入口", "产品偏差", "内部对象", "用户意图"),
    },
    {
        "key": "external_brain_loop",
        "label": "外脑闭环",
        "summary": "从采集、记忆和行动到回顾修正的长期复利循环。",
        "keywords": ("外脑", "复利", "最小闭环", "采集", "状态化计划", "反馈延迟", "执行结果", "反向修正"),
    },
    {
        "key": "memory_governance",
        "label": "记忆与治理",
        "summary": "候选记忆、来源、人工确认、过期和可撤销边界。",
        "keywords": ("长期记忆", "候选记忆", "记忆治理", "人工确认", "审批", "可撤销", "来源", "过期条件", "最终决定权"),
    },
    {
        "key": "now_action",
        "label": "此刻与行动",
        "summary": "根据当前上下文选择足够小、可启动的下一步。",
        "keywords": ("此刻", "下一步", "启动成本", "今日行动", "当前上下文", "当前推进", "承诺"),
    },
    {
        "key": "demo_narrative",
        "label": "演示叙事",
        "summary": "围绕一条真实线索组织演示、旁白、走查与反馈。",
        "keywords": ("演示", "旁白", "三分钟", "观众", "讲解", "发布", "走查", "反馈问题", "上线验收"),
    },
    {
        "key": "atlas",
        "label": "Atlas 重构",
