...
{snippet("core/receiver.py", 733, 807)}

## 文本和图片写入

{snippet("core/receiver.py", 810, 905)}

## 元数据、文件取回、归档和恢复

{snippet("core/receiver.py", 908, 942)}

{snippet("core/receiver.py", 1025, 1099)}
...
{snippet("core/receiver.py", 1102, 1179)}

{snippet("core/receiver.py", 1182, 1322)}

## 自动化产物读取

{snippet("core/receiver.py", 945, 1022)}
...
{snippet("scripts/smoke_test_receiver.py", 466, 526)}
""",
    )
