...
{snippet("core/receiver.py", 1043, 1092)}

## 文本和图片写入

{snippet("core/receiver.py", 1095, 1190)}

## 元数据、文件取回、归档和恢复

{snippet("core/receiver.py", 1193, 1227)}

{snippet("core/receiver.py", 1335, 1430)}
...
{snippet("core/receiver.py", 1433, 1510)}

{snippet("core/receiver.py", 1513, 1653)}
...
{snippet("core/receiver.py", 1230, 1332)}
...
{snippet("scripts/smoke_test_receiver.py", 420, 664)}
""",
    )
