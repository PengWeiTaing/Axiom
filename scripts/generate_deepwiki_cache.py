...
{snippet("core/receiver.py", 1033, 1100)}

## 文本和图片写入

{snippet("core/receiver.py", 1102, 1196)}

## 元数据、文件取回、归档和恢复

{snippet("core/receiver.py", 1200, 1234)}

{snippet("core/receiver.py", 1342, 1437)}
...
{snippet("core/receiver.py", 1440, 1517)}

{snippet("core/receiver.py", 1520, 1660)}

## 自动化产物读取

{snippet("core/receiver.py", 668, 809)}

{snippet("core/receiver.py", 811, 937)}

{snippet("core/receiver.py", 1237, 1339)}
