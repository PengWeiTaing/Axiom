...
export type AppMode = 'capture' | 'atlas' | 'recent' | 'processing' | 'search' | 'tasks' | 'memories' | 'decisions' | 'automation' | 'board';

const MODES: AppMode[] = ['capture', 'atlas', 'recent', 'processing', 'search', 'tasks', 'memories', 'decisions', 'automation', 'board'];
