...
- 承诺闭环与项目/生活线详情已打通；下一步验证周计划与任务拆解的最小形态。
...
1. 设计“本周真正承诺什么”的轻量计划层，不新增一级工作台。
2. 让任务拆解保留来源、父行动和完成反馈，继续由“此刻”消费。
3. 让周计划从承诺与项目脉络中选取行动，而不是形成另一份任务清单。
4. 在上述数据足够后，再接入 AI 主动建议与可撤回的拆解候选。
