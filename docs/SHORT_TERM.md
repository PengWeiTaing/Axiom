...
- 在承诺档案、项目/生活线详情和行动结果基础上，补齐任务拆解与周计划节奏。
...
- 承诺闭环、项目/生活线详情、周承诺和一层任务拆解已打通；继续用真实使用数据验证步骤粒度和完成反馈。
...
1. 基于当前一层拆解，补充 AI 可撤回候选：先预览、再确认，不自动落任务。
2. 在周末复盘中汇总“承诺行动 -> 执行步骤 -> 完成结果”，验证拆解是否真的降低启动成本。
