...
| DB-005 | 2026-06-02 | 第五阶段：修复 Vue 主线固定文件名 bundle 的缓存风险；`/static/v2/` 改为 revalidate，`/app` 保持 no-store，旧 service worker 明确绕开 `/static/v2/` | `python -m compileall -q core scripts`、`python scripts/smoke_test_web_app.py` |
