...
中枢的长期目的以 `docs/AXIOM_DISCOVERY_CORTEX_RESEARCH_V2.md` 为事实源：Axiom 不只理解与维护用户，还应自主观察世界、选择问题、寻找跨域规律、生成可证伪假说、设计验证并发现机会。`AXIOM_CORTEX_AUTONOMY_RESEARCH_V1.md` 继续约束权限、审计、回滚和双环境隔离，但治理是发现的保护边界，不是自主性的终点。新增发现能力不得膨胀一级导航，应通过“此刻”、Atlas、上下文对话或未来共同建模表面进入人的意识。
